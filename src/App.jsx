...
// import SemanticElements from './main-pages/Semantic Elements';
        ...
        <UserAuthContext>
          {/* <SemanticElements> */}
            <Routes>
              ...
              <Route path='/My_Articles' element={<MyArticles/>}></Route>
              <Route path='/Edit_Article/:id' element={<EditArticle/>}></Route>
            </Routes>
          {/* </SemanticElements> */}
        </UserAuthContext>
      </HashRouter>
